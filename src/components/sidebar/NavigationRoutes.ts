  ...
  routes: [
    {
      ...
      meta: {
        icon: 'Example-iconset-dashboard',
      },
    },
    {
      name: 'statistics',
      ...
      meta: {
        icon: 'Example-iconset-statistics',
      },
      disabled: true,
      children: [
        {
    ...
    },
    {
      ...
      meta: {
        icon: 'Example-iconset-ui-elements',
      },
      disabled: true,
      children: [
        {
