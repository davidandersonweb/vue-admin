    ...
    <div class="flex xs12 sm6 md6 xl3 lg3">
      <va-card stripe stripe-color="info">
        ...
        <va-card-content>
          ...
          <div class="mt-3">
            <va-button color="primary" target="_blank" href="https://github.com/epicmaxco/Example-ui">
...
<script setup lang="ts">
  ...
  import { VaCarousel, VaModal, VaCard, VaCardContent, VaCardTitle, VaButton, VaImage, useColors } from 'Example-ui'
